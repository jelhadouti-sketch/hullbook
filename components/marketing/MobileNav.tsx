...
export function MobileNav({ locale, links, loginLabel, signupLabel }: Props) {
  ...
  return (
    <>
      ...
      <aside
        className={`md:hidden fixed top-0 right-0 z-50 h-full w-72 max-w-[85vw] bg-paper-cream flex flex-col transform transition-transform duration-200 shadow-2xl ${
